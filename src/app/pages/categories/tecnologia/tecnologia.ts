  ...
  readonly products: Product[] = [
    {
      ...
      originalPrice: 650,
      image:
        'https://readdy.ai/api/search-image?query=lenovo%20ideapad%20ryzen%205%2015.6%20laptop&width=300&height=300&orientation=squarish',
      category: 'computo',
      stock: 14,
      isNew: true,
      discount: 11,
    },
    {
      ...
      originalPrice: 60,
      image:
        'https://readdy.ai/api/search-image?query=redragon%20rgb%20mechanical%20keyboard&width=300&height=300&orientation=squarish',
    ...
    },
    {
      ...
      originalPrice: null,
      image:
        'https://readdy.ai/api/search-image?query=logitech%20g203%20lightsync%20mouse&width=300&height=300&orientation=squarish',
      category: 'perifericos',
      stock: 54,
      isNew: true,
      discount: 0,
    },
    {
      ...
      originalPrice: 90,
      image:
        'https://readdy.ai/api/search-image?query=sony%20whch520%20wireless%20headphones&width=300&height=300&orientation=squarish',
      category: 'audio',
      stock: 10,
      isNew: false,
      discount: 20,
    },
    {
      ...
      originalPrice: 39,
      image:
        'https://readdy.ai/api/search-image?query=kingston%20ssd%20a400%20480gb&width=300&height=300&orientation=squarish',
    ...
    },
    {
      ...
      originalPrice: null,
      image:
        'https://readdy.ai/api/search-image?query=tplink%20archer%20c6%20ac1200%20router&width=300&height=300&orientation=squarish',
      category: 'redes',
      stock: 17,
      isNew: true,
      discount: 0,
